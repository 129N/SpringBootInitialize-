...
public class Country_test extends AbstractDomain_Test<Long, Country> {


    public static List<Country> TEST_DATA = new LinkedList<>(
            List.of(Country.builder().name("USA").sign("US").build(),
    ...
    public Country_test(PostgreSQLContainer<?> postgres, JpaRepository<Country, Long> repository){
    ...
    @Override
    protected List<ConstrainViolationEntity<Long, Country>> getConstraintViolationEntities() {
        return List.of(

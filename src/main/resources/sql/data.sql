...
insert into country(name, sign)
values ('Betelgeuse', 'BET');
insert into country(name, sign)
values ('Earth', 'EARTH');
insert into country(name, sign)
values ('Viltvolde VI', 'VV');
insert into country(name, sign)
values ('Vogsphere', 'VOG');
insert into country(name, sign)
values ('Magrathean', 'MA');
insert into country(name, sign)
values ('Ursa Minor Beta', 'UMB');

insert into company(name, address, amount, country, tax_id, established, capitalisation)
values ('Sirius Cybernetics Corporation',
        'Ursa Minor Beta',
        1000,
...
;
insert into company(name, address, amount, country, tax_id, established, capitalisation)
values ('Infinite Improbability Drive',
        'Ursa Minor Beta',
        2000,
        (select id from country where sign = 'UMB'),
        '987654321',
...
;
insert into company(name, address, amount, country, tax_id, established, capitalisation)
values ('The Hitchhikers Guide to the Galaxy',
'London',
5000,
